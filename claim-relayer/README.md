...
This copy stays under `claim-relayer/` until Spencer asks to move it. Product name is Bot Verifier. The Render service slug stays `bot-verifier-claim-relayer` unless Spencer renames it in the dashboard.
