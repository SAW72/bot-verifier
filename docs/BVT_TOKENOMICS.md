...
The product is Agent BV — Bot Verifier. **Bot Verifier Token (BVT)** is the on-chain ERC-20 name that prices audits, bonds auditors, and governs protocol parameters. There is **no premine for sale**, no VC allocation, and no public-sale mint.
